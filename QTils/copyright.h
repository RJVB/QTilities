...
#define COPYRIGHT "\015\013\tQTils: $Copyright (c) 2010 INRETS / RJVB. All rights reserved.$\015\013"
...
#define XG_IDENTIFY()	"QTils v1.0 '" __FILE__ "'-[" __DATE__ "," __TIME__ "]"
...
#	define CRASHREPORTER(s,o) const char *__crashreporter_info__ = s+o; asm(".desc ___crashreporter_info__, 0x10"); __crashreporter_info__=__crashreporter_info__;
#else
#	define CRASHREPORTER(s,o)	/**/
#endif
