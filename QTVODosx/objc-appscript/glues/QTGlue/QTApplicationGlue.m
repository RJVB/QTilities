...
- (id)initWithTargetType:(ASTargetType)targetType_ data:(id)targetData_ {
    ...
    appData = [[ASAppData alloc] initWithApplicationClass: [AEMApplication class]
                                            constantClass: [QTConstant class]
                                           referenceClass: [QTReference class]
...
- (QTReference *)AS_referenceWithObject:(id)object {
    if ([object isKindOfClass: [QTReference class]])
        return [[[QTReference alloc] initWithAppData: AS_appData
